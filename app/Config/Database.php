...
class Database extends Config
{
    ...
    public function __construct()
    {
        ...
        $this->default['port']     = (int) env('DB_DTOT_PORT', $this->default['port']);
        ...
        $this->cadeb['port']     = (int) env('DB_CADEB_PORT', $this->cadeb['port']);
        ...
        $this->sqlsrv['port']     = (int) env('DB_SQLSRV_PORT', $this->sqlsrv['port']);
    }
}
