        ...
        <div class="card-body p-4">
            <form id="filterForm" method="GET" action="<?= current_url() ?>" class="flex flex-col sm:flex-row gap-3 items-end">
                ...
                <div class="form-control pb-0.5">
                    <a href="<?= current_url() ?>" class="btn btn-ghost btn-sm text-base-content/60 hover:text-base-content" title="Reset Filter">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4">
                        ...
                        <?php foreach ($submissions as $row): ?>
                            <tr class="hover">
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url('pengajuan/proses/' . $row->id) ?>" class="btn btn-xs btn-primary btn-square" title="Proses Pengajuan">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4">
