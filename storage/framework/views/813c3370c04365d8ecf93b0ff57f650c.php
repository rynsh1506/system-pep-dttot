<div>
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        ...
        <a href="<?php echo e(route('report.export', ['start_date' => $startDate, 'end_date' => $endDate, 'dttot' => $filterDttot, 'pep' => $filterPep])); ?>" class="btn btn-success btn-sm gap-2 text-white shrink-0">
        ...
        <div class="card-body p-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
                <div class="form-control w-full">
                    ...
                    <div x-data x-init="flatpickr($refs.picker, { dateFormat: 'Y-m-d', locale: '<?php echo e(app()->getLocale() == 'ja' ? 'ja' : (app()->getLocale() == 'en' ? 'en' : 'id')); ?>' })" class="w-full">
    ...
    <div class="grid grid-cols-3 gap-4 mb-5">
        <div class="stat bg-base-100 border border-base-200 rounded-2xl shadow-sm p-4">
            ...
            <div class="stat-value text-2xl text-primary"><?php echo e(number_format($total)); ?></div>
        </div>
        <div class="stat bg-base-100 border border-error/30 rounded-2xl shadow-sm p-4">
            ...
            <div class="stat-value text-2xl text-error"><?php echo e(number_format($terindikasi)); ?></div>
        </div>
        <div class="stat bg-base-100 border border-success/30 rounded-2xl shadow-sm p-4">
            ...
            <div class="stat-value text-2xl text-success"><?php echo e(number_format($tidakTerindikasi)); ?></div>
        </div>
    </div>
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover">
                            ...
                            <td class="font-semibold text-sm"><?php echo e($row->nama_cadeb); ?></td>
                            ...
                            <td>
                                ...
                                <span class="badge <?php echo e($dttotClass); ?> badge-sm font-medium whitespace-nowrap"><?php echo e($row->hasil_pengecekan ?? 'Belum Dicek'); ?></span>
                            </td>
                            <td>
                                ...
                                <span class="badge <?php echo e($pepClass); ?> badge-sm font-medium whitespace-nowrap"><?php echo e($row->hasil_pep ?? '-'); ?></span>
                            </td>
                            <td class="text-xs text-base-content/60"><?php echo e(Str::limit($row->keterangan, 60) ?? '-'); ?></td>
                            <td class="text-center">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row->bukti_ss): ?>
                                    <a href="<?php echo e(asset('storage/' . $row->bukti_ss)); ?>" target="_blank" class="btn btn-ghost btn-xs text-primary">Lihat</a>
                                <?php else: ?>
                                    <span class="text-base-content/30">-</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td class="text-xs font-medium"><?php echo e($row->userPemeriksa->nama_lengkap ?? $row->checked_by ?? '-'); ?></td>
                            <td class="text-xs"><?php echo e($row->checked_at ? \Carbon\Carbon::parse($row->checked_at)->format('d/m/Y H:i') : '-'); ?></td>
                        </tr>
...
<?php /**PATH /var/www/resources/views/livewire/report-pengajuan.blade.php ENDPATH**/ ?>