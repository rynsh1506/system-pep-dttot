<div>
    <div class="flex items-center gap-3 mb-8">
        <a href="<?php echo e(route('home')); ?>" class="btn btn-circle btn-ghost btn-sm">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                <path fill-rule="evenodd" d="M17 10a.75.75 0 0 1-.75.75H5.612l4.158 3.96a.75.75 0 1 1-1.04 1.08l-5.5-5.25a.75.75 0 0 1 0-1.08l5.5-5.25a.75.75 0 1 1 1.04 1.08L5.612 9.25H16.25A.75.75 0 0 1 17 10Z" clip-rule="evenodd"/>
            </svg>
        </a>
        <div>
            <h1 class="text-2xl font-bold text-base-content"><?php echo e(__('Upload Data Massal')); ?></h1>
            <p class="text-sm text-base-content/60 mt-0.5"><?php echo e(__('Impor data Terduga Teroris dari file Excel atau CSV.')); ?></p>
        </div>
    </div>
                ...
                <div class="card-body">
                    <form wire:submit.prevent="upload">
                        ...
                        <div x-data="{ isDropping: false }"
                             ...
                             :class="{ 'border-primary bg-primary/5': isDropping, 'border-base-300 hover:border-primary/50 hover:bg-base-200/50': !isDropping, 'border-error bg-error/5': <?php $__errorArgs = ['file'];
...
unset($__errorArgs, $__bag); ?> }">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($file): ?>
                                <div class="flex flex-col items-center">
                                    ...
                                    <span class="font-medium text-base-content text-center"><?php echo e($file->getClientOriginalName()); ?></span>
                                    <span class="text-xs text-base-content/50 mt-1"><?php echo e(number_format($file->getSize() / 1024, 1)); ?> KB</span>
                                </div>
                            <?php else: ?>
                                <div class="flex flex-col items-center pointer-events-none">
                                    ...
                                    <h3 class="text-lg font-bold text-base-content mb-1"><?php echo e(__('Tarik & Lepas File ke Sini')); ?></h3>
                                    <p class="text-sm text-base-content/60"><?php echo e(__('atau klik untuk menelusuri dari perangkat')); ?></p>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="mt-8 flex items-center justify-end gap-3 border-t border-base-200 pt-6">
                            <a href="<?php echo e(route('home')); ?>" class="btn btn-ghost"><?php echo e(__('Batal')); ?></a>
                            <button type="submit" class="btn btn-primary min-w-[140px]" <?php if(!$file): ?> disabled <?php endif; ?>>
            ...
            <div class="card bg-info/10 border border-info/20 shadow-sm rounded-2xl">
                <div class="card-body">
                    <h3 class="card-title text-info text-sm uppercase tracking-widest flex items-center gap-2">
                        ...
                        <?php echo e(__('Petunjuk Format')); ?>

                    </h3>
                    <p class="text-sm text-base-content/80 mt-2">
                        <?php echo e(__('Pastikan file Excel Anda memiliki urutan kolom berikut (tanpa header diperbolehkan, tapi urutan harus sama):')); ?>
...
<?php /**PATH /var/www/resources/views/livewire/upload-data.blade.php ENDPATH**/ ?>