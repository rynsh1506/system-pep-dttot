<div>
    <div class="mb-6 flex flex-col gap-1">
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('search')); ?>" class="btn btn-sm btn-ghost gap-2 text-base-content/70 hover:text-base-content hover:bg-base-200">
            ...
            <h2 class="text-xl font-bold text-base-content"><?php echo e(__('Detail Informasi Terduga')); ?></h2>
        </div>
    </div>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($terduga->is_pending): ?>
        <div class="alert alert-warning shadow-sm mb-6 max-w-5xl rounded-xl border-l-4 border-l-warning">
            ...
            <span><strong><?php echo e(__('Menunggu Persetujuan:')); ?></strong> <?php echo e(__('Data ini sedang dalam proses review berjenjang dan belum dipublikasikan secara final.')); ?></span>
        </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-2">
                        <div class="badge <?php echo e($terduga->terduga_type == 'Orang' ? 'badge-info' : 'badge-warning'); ?> badge-outline font-medium">
                            <?php echo e($terduga->terduga_type); ?>

                        </div>
                        <div class="badge badge-ghost font-mono text-xs">
                            <?php echo e($terduga->kode_densus ?: 'NO-ID'); ?>
                    ...
                    <h3 class="text-2xl font-bold text-primary leading-snug">
                        <?php echo e($terduga->nama); ?>

                    </h3>
                </div>
                
                <div class="flex flex-wrap gap-2 shrink-0">
                    <a href="<?php echo e(route('edit-data', $terduga->id)); ?>" class="btn btn-sm btn-outline btn-primary">
                    ...
                    <button x-data="{
                        confirmDelete() {
                            Swal.fire({
                                title: '<?php echo e(__('Konfirmasi Hapus')); ?>',
                                text: '<?php echo e(__('Apakah Anda yakin ingin mengajukan penghapusan subjek ini?')); ?>',
                                icon: 'warning',
                                showCancelButton: true,
                                confirmButtonColor: '#ef4444',
                                cancelButtonColor: '#3b82f6',
                                confirmButtonText: '<?php echo e(__('Ya, Hapus')); ?>',
                                cancelButtonText: '<?php echo e(__('Batal')); ?>'
                            }).then((result) => {
                                if (result.isConfirmed) {
                                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').deleteTerduga();
                                }
                            });
                        }
        ...
        <div class="card-body p-6 md:p-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                ...
                <div class="space-y-6">
                    <h4 class="text-sm font-bold text-base-content/50 uppercase tracking-wider flex items-center gap-2">
                        ...
                        <?php echo e(__('Identitas Dasar')); ?>

                    </h4>
                    
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <div class="text-xs text-base-content/50 mb-1"><?php echo e(__('Tempat Lahir')); ?></div>
                            <div class="font-medium text-base-content"><?php echo e($terduga->tempat_lahir ?: '-'); ?></div>
                        </div>
                        <div>
                            <div class="text-xs text-base-content/50 mb-1"><?php echo e(__('Tanggal Lahir')); ?></div>
                            <div class="font-medium text-base-content"><?php echo e($terduga->tanggal_lahir ? $terduga->tanggal_lahir : '-'); ?></div>
                        </div>
                        <div>
                            <div class="text-xs text-base-content/50 mb-1"><?php echo e(__('Warga Negara')); ?></div>
                            <div class="font-medium text-base-content"><?php echo e($terduga->wn_asal_negara ?: '-'); ?></div>
                        </div>
                        <div>
                            <div class="text-xs text-base-content/50 mb-1"><?php echo e(__('Tanggal Input Data')); ?></div>
                            <div class="font-medium text-base-content"><?php echo e($terduga->created_at->format('d M Y, H:i')); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <h4 class="text-sm font-bold text-base-content/50 uppercase tracking-wider flex items-center gap-2">
                        ...
                        <?php echo e(__('Alamat Lengkap')); ?>

                    </h4>
                    
                    <div class="bg-base-200/50 p-4 rounded-xl text-sm leading-relaxed text-base-content border border-base-200">
                        <?php echo nl2br(e($terduga->alamat)) ?: '<em class="text-base-content/40">' . __('Tidak ada informasi alamat yang dicatat.') . '</em>'; ?>
            ...
            <div class="space-y-6 pt-6 border-t border-base-200">
                <h4 class="text-sm font-bold text-base-content/50 uppercase tracking-wider flex items-center gap-2">
                    ...
                    <?php echo e(__('Catatan & Deskripsi Kejahatan')); ?>

                </h4>
                
                <div class="bg-base-200/30 p-5 rounded-xl text-sm leading-relaxed text-base-content whitespace-pre-wrap font-sans border border-base-200"><?php echo nl2br(e($terduga->deskripsi)) ?: '<em class="text-base-content/40">' . __('Tidak ada deksripsi atau catatan keterlibatan khusus.') . '</em>'; ?></div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /var/www/resources/views/livewire/terduga-detail.blade.php ENDPATH**/ ?>