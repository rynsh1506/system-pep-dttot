    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="sidebar-menu">
                <li>
                    <a href="../portal.php"
                        style="border-bottom: 1px solid rgba(255,255,255,0.1); margin-bottom: 5px; padding-bottom: 10px; opacity: 0.75;">
                ...
                <div class="nav-right">
                    <div class="nav-user" style="position: relative;">
                        ...
                        <div id="userDropdown"
                            ...
                            <a href="../portal.php"
                                style="display: block; padding: 1rem; color: var(--text-primary); text-decoration: none; font-size: 0.9rem; border-bottom: 1px solid var(--border-color);">
                                <i class="fas fa-th-large" style="margin-right: 10px; color: var(--accent-color);"></i>
                                Kembali ke Portal
                            </a>
                            <a href="../logout.php"
