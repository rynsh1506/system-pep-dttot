...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'add') {
    ...
    try {
        // Use $pdo_portal and corrected field names (nama_lengkap, level)
        $stmt = $pdo_portal->prepare("INSERT INTO users (username, password, nama_lengkap, level) VALUES (?, ?, ?, ?)");
...
$stmt = $pdo_portal->query("SELECT * FROM users ORDER BY level DESC, username ASC");
$users = $stmt->fetchAll();
?>
